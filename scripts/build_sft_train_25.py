#!/usr/bin/env python3
"""
scripts/build_sft_train_25.py
Creates 25 diverse, high-quality SFT examples for fine-tuning an
LLM as a startup advisor.  The output file is:
    data_processed/sft_train.jsonl
Run:
    python scripts/build_sft_train_25.py
"""
...
OUT_FILE = OUT_DIR / "sft_train.jsonl"
...
examples: list[dict] = [
    ...
    dict(
        ...
        output=(
            "1. Offer subscription per acre ($2/acre/season) instead of hardware sales—farmers prefer OPEX.\n"
    ...
    dict(
        ...
        output=(
            ...
            "2. Structure revenue: sell verified carbon credits ($8/ton) to corporates—projected "
            "ARR $1.6 M at 40 k lanterns.\n"
...
print(f"✅  Wrote {len(examples)} diverse examples to {OUT_FILE}")
